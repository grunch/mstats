...
- **FR-012**: The tool MUST support filtering statistics by fiat currency.
...
- **FR-017**: The tool MUST explicitly report events that could not be processed (missing tags, no matching kind 38383, malformed data).
